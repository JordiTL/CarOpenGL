...
# Macros
CND_PLATFORM=MinGW_CODEBLOCKS-Windows
CND_DLIB_EXT=dll
CND_CONF=Debug
CND_DISTDIR=dist
CND_BUILDDIR=build
...
${OBJECTDIR}/Objects.o: Objects.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I/C/Program\ Files\ \(x86\)/CodeBlocks/MinGW/include -I/C/Program\ Files\ \(x86\)/CodeBlocks/MinGW/include/GL -MMD -MP -MF $@.d -o ${OBJECTDIR}/Objects.o Objects.cpp

${OBJECTDIR}/load3ds.o: load3ds.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/load3ds.o load3ds.c

${OBJECTDIR}/loadjpeg.o: loadjpeg.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/loadjpeg.o loadjpeg.c

${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I/C/Program\ Files\ \(x86\)/CodeBlocks/MinGW/include -I/C/Program\ Files\ \(x86\)/CodeBlocks/MinGW/include/GL -MMD -MP -MF $@.d -o ${OBJECTDIR}/main.o main.cpp
